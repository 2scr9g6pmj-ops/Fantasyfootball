...
def home():
    ...
    <div id='status' class='status'>Loading synced leagues…</div><div class='cards' id='cards'></div><div id='changes' class='empty' hidden></div><div id='empty' class='empty' hidden></div><table id='lineupTable' hidden><thead><tr><th>Slot</th><th>Player</th><th>Team</th><th>Sleeper Projection</th><th>Aggregated Projection</th><th>Sources</th><th>Start Score</th><th>Health</th><th>Why</th></tr></thead><tbody id='lineup'></tbody></table><p><a href='/draft'>Draft Room</a> · <a href='/docs'>API & projection import</a></p>
    <script>
